...
admin.site.site_header = "SparC"
admin.site.site_title = "SparC Admin Portal"
admin.site.index_title = "SparC Admin"

# swagger
api_info = openapi.Info(
    title="SparC API",
    default_version="v1",
    description="API documentation for SparC App",
)
